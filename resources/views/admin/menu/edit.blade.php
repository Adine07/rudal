                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control" value="{{ old('name', $menu->name) }}" name="name"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea name="detail" id="detail">{{ old('detail', $menu->detail) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" id="price" class="form-control" value="{{ old('price', $menu->price) }}" name="price"
